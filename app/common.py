...
users_collection: motor_typing.AsyncCollection = mongodb_client['magicdex-db']['users']
cards_collection: motor_typing.AsyncCollection = mongodb_client['magicdex-db']['cards']
