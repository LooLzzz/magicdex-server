...
from ..common import ACCESS_TOKEN_EXPIRE
from ..models import TokenResponse, UserSchema
...
async def register(form_data: UserSchema = Depends()):
    user = services.create_user(form_data)
